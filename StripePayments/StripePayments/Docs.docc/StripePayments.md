...
If you need to accept card payments, we advise using the [StripePaymentSheet](https://github.com/stripe/stripe-ios/tree/23.28.0/StripePayments/../StripePaymentSheet/README.md) or [StripePaymentsUI](https://github.com/stripe/stripe-ios/tree/23.28.0/StripePayments/../StripePaymentsUI/README.md) module. For more information, visit our [integration security guide](https://stripe.com/docs/security/guide).
